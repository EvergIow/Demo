...
public class ExcelRead {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<List<String>> chexingList = poi.read("C:\\Users\\cjs\\Desktop\\123\\车型销售代码BDL表20180919.xlsx");
        if (chexingList != null) {
            for (int i = 0; i < chexingList.size(); i++) {
              
                List<String> cellList = chexingList.get(i);
//                for (int j = 0; j < cellList.size(); j++) {
//                    // System.out.print("    第" + (j + 1) + "列值：");
//                    System.out.print("    " + cellList.get(j));
//                }
                System.out.println(cellList.get(8).toString());
                System.out.println();
            }
